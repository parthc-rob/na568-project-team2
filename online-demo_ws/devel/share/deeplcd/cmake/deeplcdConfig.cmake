...
if("TRUE" STREQUAL "TRUE")
  set(deeplcd_SOURCE_PREFIX /media/psf/Home/ning_documents/course/rob530/calc/DeepLCD/online-demo_ws/src)
  set(deeplcd_DEVEL_PREFIX /media/psf/Home/ning_documents/course/rob530/calc/DeepLCD/online-demo_ws/devel)
  set(deeplcd_INSTALL_PREFIX "")
  set(deeplcd_PREFIX ${deeplcd_DEVEL_PREFIX})
else()
  set(deeplcd_SOURCE_PREFIX "")
  set(deeplcd_DEVEL_PREFIX "")
  set(deeplcd_INSTALL_PREFIX /media/psf/Home/ning_documents/course/rob530/calc/DeepLCD/online-demo_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'nmerrill <nmerrill@udel.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'deeplcd' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'deeplcd' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/psf/Home/ning_documents/course/rob530/calc/DeepLCD/online-demo_ws/src/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/psf/Home/ning_documents/course/rob530/calc/DeepLCD/online-demo_ws/devel/lib;/media/psf/Home/ning_documents/course/rob530/calc/DeepLCD/online-demo_ws/devel/lib;/opt/ros/kinetic/lib)
